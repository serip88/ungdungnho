...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url()?>/app/lib/css/bootstrap.css">
    <link rel="stylesheet" href="css/font-awesome.css">
    <link rel="stylesheet" href="css/styles.css">
    <link rel="stylesheet" href="css/mystyles.css">
    <link rel="stylesheet" href="css/be-ang/css/animate.css" type="text/css" />
    <!--<link rel="stylesheet" href="css/be-ang/css/font-awesome.min.css" type="text/css" />-->
    <link rel="stylesheet" href="css/be-ang/css/simple-line-icons.css" type="text/css" />
    <!--<link rel="stylesheet" href="css/be-ang/css/font.css" type="text/css" />-->
    <link rel="stylesheet" href="css/be-ang/css/app.css" type="text/css" />
</head>
            ...
            <div class="row" data-gutter="60">
                <div class="col-md-9">
                    ...
                    <div class="row row-col-gap" data-gutter="15">
                        <div class="col-md-6">
                            <div class="banner banner-o-hid" style="background-image:url(img/600x300.png);">
                                ...
                                <img class="banner-img" src="img/test_banner/24-i.png" alt="Image Alternative text" title="Image Title" style="top: -10px; right: -45px; width: 270px;" />
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="banner banner-o-hid" style="background-image:url(img/550x292.png);">
                                ...
                                <img class="banner-img" src="img/test_banner/21-i.png" alt="Image Alternative text" title="Image Title" style="bottom: -29px; right: -51px; width: 240px;" />
                            </div>
                        </div>
                    </div>
                    <div class="gap"></div>
                    ...
                    <div class="owl-carousel owl-loaded owl-nav-out" data-options='{"items":5,"loop":true,"nav":true}'>
                        ...
                        <div class="owl-item">
                            <div class="product product-sm owl-item-slide">
                                <div class="product-img-wrap">
                                    <img class="product-img" src="img/2100x2100.png" alt="Image Alternative text" title="Image Title" />
                                </div>
                                <a class="product-link" href="#"></a>
                                <div class="product-caption">
                                    <ul class="product-caption-rating">
                    ...
                    <div class="row row-col-gap" data-gutter="15">
                        <div class="col-md-6">
                            <div class="banner banner-o-hid" style="background-color:#D2D2D2;">
                                ...
                                <img class="banner-img" src="img/test_banner/28-i.png" alt="Image Alternative text" title="Image Title" style="bottom: 0px; right: -25px; width: 240px;" />
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="banner banner-o-hid" style="background-color:#DF643B;">
                                ...
                                <img class="banner-img" src="img/test_banner/6-i.png" alt="Image Alternative text" title="Image Title" style="bottom: 0px; right: -120px; width: 326px;" />
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-3">
                    <div class="row" data-gutter="15">
                        <div class="col-md-12">
                            <div class="banner banner-o-hid banner-sm" style="background-image:url(img/240x200.png);">
                                <a class="banner-link" href="#"></a>
                                <div class="banner-caption-left">
